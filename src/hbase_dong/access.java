...
public class access {
	...
	public final static String OUT_PATH = "hdfs://hadoop0:9000/hbase_data/allWeb";
	...
	public static void main(String[] args) throws Exception {
		...
		FileOutputFormat.setOutputPath(job, new Path("hdfs://hadoop0:9000/hbase_data/allWeb"));
